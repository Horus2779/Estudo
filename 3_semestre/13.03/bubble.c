...
int main(void){
    ...
    mostra(vet, 20);
    ftime(& fim);
    dif = (int)(100 * (fim.time - inic.time) + (fim.millitm - inic.millitm));
    ...
    printf("Tempo de ordenacao bubble = %dms\n", dif);

	ftime(& inic);
    bubble_sort(vet, tam);
    ftime(& fim);
    dif = (int)(1000 * (fim.time - inic.time) + (fim.millitm - inic.millitm));
    printf("Tempo de ordenacao arrumado bubble = %dms\n", dif);

	ftime(& inic);
    insert_sort(vet, tam);
    ftime(& fim);
    dif = (int)(1000 * (fim.time - inic.time) + (fim.millitm - inic.millitm));
    printf("Tempo de ordenacao insert = %dms\n", dif);
    
    ftime(& inic);
    insert_sort(vet, tam);
    ftime(& fim);
    dif = (int)(1000 * (fim.time - inic.time) + (fim.millitm - inic.millitm));
    printf("Tempo de ordenacao arrumado insert = %dms\n", dif);
